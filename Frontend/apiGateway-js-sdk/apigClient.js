...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://q7434mwcyc.execute-api.us-west-2.amazonaws.com/prod';
    ...
    apigClient.searchImagesPost = function (params, body, additionalParams) {
        ...
        var searchImagesPostRequest = {
            ...
            path: pathComponent + uritemplate('/search-images').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(searchImagesPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.searchImagesOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var searchImagesOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(searchImagesOptionsRequest, authType, additionalParams, config.apiKey);
    };
